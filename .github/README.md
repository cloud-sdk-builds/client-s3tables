...
[`@aws-sdk/client-s3tables`](https://www.npmjs.com/package/@aws-sdk/client-s3tables/v/3.1045.0).
...
- @aws-sdk/client-s3tables - [https://cloud-sdk-builds.github.io/?sdk=client-s3tables](https://cloud-sdk-builds.github.io/?sdk=client-s3tables)
- @aws-sdk/client-s3tables v3.1045.0 - [https://cloud-sdk-builds.github.io/?sdk=client-s3tables&version=3.1045.0](https://cloud-sdk-builds.github.io/?sdk=client-s3tables&version=3.1045.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3tables@3.1045.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3fDpLTADOzYxFR33Tyo+Zo11i67QyXopZtzNBcy1cOq089T4SgHUvaSeqFNwyILo
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3tables/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-s3tables": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3tables@3.1045.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3tables@3.1045.0/index.min.mjs": "sha384-3fDpLTADOzYxFR33Tyo+Zo11i67QyXopZtzNBcy1cOq089T4SgHUvaSeqFNwyILo"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-s3tables";
...
```
https://github.com/cloud-sdk-builds/client-s3tables/blob/refs/tags/3.1045.0/LICENSE
```
