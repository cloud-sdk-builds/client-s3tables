...
[`@aws-sdk/client-s3tables`](https://www.npmjs.com/package/@aws-sdk/client-s3tables/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3tables@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RUPRIu/pYlSUI8kJQauGlN6D8mxPWWb/kd8ARO8gduLrB2p4r/uu+zfPsGxjs92Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-s3tables": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3tables@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3tables@3.882.0/index.min.mjs": "sha384-RUPRIu/pYlSUI8kJQauGlN6D8mxPWWb/kd8ARO8gduLrB2p4r/uu+zfPsGxjs92Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-s3tables/blob/refs/tags/3.882.0/LICENSE
```
